local YEETUS_VERSION="10.09.2023"
...
writefile("YEETUS/YEETUS.li", text)
end
...
local YeetusNotification=Instance.new("ScreenGui")
...
local YeetusIcon_1=Instance.new("ImageLabel")
...
YeetusNotification.Name=c.generatebytes()
YeetusNotification.Parent=game.CoreGui
YeetusNotification.DisplayOrder=2147483647
holder_1.Parent=YeetusNotification
...
YeetusIcon_1.Parent=Top_1
YeetusIcon_1.AnchorPoint=Vector2.new(0.5, 0.5)
YeetusIcon_1.BackgroundColor3=Color3.fromRGB(255, 255, 255)
YeetusIcon_1.BackgroundTransparency=1
YeetusIcon_1.BorderColor3=Color3.fromRGB(27, 42, 53)
YeetusIcon_1.Position=UDim2.new(-0.12110053, 0, 0.5, 0)
YeetusIcon_1.Size=UDim2.new(0, 21, 0, 21)
YeetusIcon_1.Image="rbxassetid://14714966860"
